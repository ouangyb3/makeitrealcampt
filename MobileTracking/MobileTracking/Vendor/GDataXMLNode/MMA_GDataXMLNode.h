...
_EXTERN const char* kMMAGDataXMLXPathDefaultNamespacePrefix _INITIALIZE_AS("_def_ns");
...
@interface MMA_GDataXMLNode : NSObject <NSCopying> {
@protected
...
- (MMA_GDataXMLNode *)attributeForLocalName:(NSString *)name URI:(NSString *)attributeURI;
