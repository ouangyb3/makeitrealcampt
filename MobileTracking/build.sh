...
xcodebuild -target $targetName -sdk iphoneos13.0 # build iphoneos

#build iphonesimulator
xcodebuild -target $targetName -configuration ${CONFIGURATION} -sdk iphonesimulator13.0  -arch x86_64 -arch i386
