...
xcodebuild -target $targetName -sdk iphoneos12.4 # build iphoneos

#build iphonesimulator
xcodebuild -target $targetName -configuration ${CONFIGURATION} -sdk iphonesimulator12.4  -arch x86_64 -arch i386
