...
- (void)enqueueFrame:(VAMonitorFrame *)frame {
     ...
     *  计算曝光时长
     */
    NSLog(@"###size:%f",(1 - frame.coverRate));
...
- (NSString *)generateUploadEvents {
    ...
    [outputframes enumerateObjectsUsingBlock:^(VAMonitorFrame * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        NSDictionary *dictionary = @{
                                     ...
                                     AD_VB_FRAME : VAPixelStringFromSize(obj.frame.size), // 广告原始尺寸
                                     AD_VB_POINT : VAPixelStringFromPoint(obj.windowFrame.origin), // 广告可视的原点位置
                                     ...
                                     AD_VB_SHOWFRAME : VAPixelStringFromSize(obj.showFrame.size), // 广告可视尺寸
